    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _app_routing__WEBPACK_IMPORTED_MODULE_3__["appRouting"].routes,
                _core_core_module__WEBPACK_IMPORTED_MODULE_4__["CoreModule"],
                _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"] //Shared (multi-instance) objects
            ],
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _app_routing__WEBPACK_IMPORTED_MODULE_3__["appRouting"].components],
...
var routes = [
    ...
    { path: 'customers/:id', component: _customers_customer_edit_component__WEBPACK_IMPORTED_MODULE_3__["CustomerEditComponent"] },
    //{ path: 'customers/:id', component: CustomerEditReactiveComponent },
    { path: '**', pathMatch: 'full', redirectTo: '/customers' } //catch any unfound routes and redirect to home page
];
var appRouting = {
    routes: _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forRoot(routes, { useHash: true }),
    components: [_customers_customers_component__WEBPACK_IMPORTED_MODULE_1__["CustomersComponent"], _customers_customer_edit_component__WEBPACK_IMPORTED_MODULE_3__["CustomerEditComponent"], _customers_customer_edit_reactive_component__WEBPACK_IMPORTED_MODULE_4__["CustomerEditReactiveComponent"], _customers_customers_grid_component__WEBPACK_IMPORTED_MODULE_2__["CustomersGridComponent"]]
};
...
var DataService = /** @class */ (function () {
    function DataService(http) {
        ...
        this.baseStatesUrl = 'http://localhost:3000/api/states';
    }
...
var CustomersComponent = /** @class */ (function () {
    ...
    CustomersComponent.prototype.getCustomersPage = function (page) {
        ...
        this.dataService.getCustomersPage((page - 1) * this.pageSize, this.pageSize)
            ...
            _this.customers = _this.filteredCustomers = response.results.customers;
            _this.totalRecords = response.results.count;
...
module.exports = __webpack_require__(/*! /Users/amitkumar/Projects/Angular4 Project/Angular-NodeJS-MongoDB-CustomersService /client/src/main.ts */"./src/main.ts");
